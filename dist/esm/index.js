...
var colorful = function () {
    ...
    log$1.apply(void 0, __spreadArray([style], args, false));
};
var blue = function () {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
...
var add = function () {
    ...
    var effectiveArgs = args.map(function (arg) { return +arg; }).filter(function (arg) { return isNumber(arg) && !isNaN(arg); });
    return effectiveArgs.reduce(function (previousValue, currentValue) {
        return Decimal.add(previousValue, currentValue).toNumber();
    }, 0);
};

function setCssVarProperties() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    }
    var dom = args[0], values = args[1];
